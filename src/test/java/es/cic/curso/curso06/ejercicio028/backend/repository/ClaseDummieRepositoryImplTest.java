...
import es.cic.curso.curso06.ejercicio028.backend.dominio.Dummie;
import es.cic.curso.curso06.ejercicio028.backend.repository.ClaseDummieRepository;
import es.cic.curso.curso06.ejercicio028.backend.repository.IRepository;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
    "classpath:es/cic/curso/curso06.ejercicio028/applicationContext.xml"})
